...
<section class="dashboard-intro">
    <div class="dashboard-intro__copy">
        ...
        <p>تم تجهيز الهيكل الإداري الموحّد. ستُربط البيانات التشغيلية الموثوقة تدريجيًا في المراحل التالية بدون تغيير الأنظمة الحالية.</p>
    </div>
...
<section class="kpi-grid" aria-label="المؤشرات الرئيسية غير المتصلة">
    ...
    <?php cc_kpi_card('الموزعون النشطون', 'غير متاح بعد', 'سيُربط بقاعدة الموزعين في Phase 2.', 'briefcase'); ?>
...
<section class="dashboard-grid">
    ...
    <article class="panel">
        ...
        <div class="source-list">
            <div class="source-row"><span class="source-row__icon"><?= cc_icon('pulse') ?></span><span><strong>Operations</strong><small>سلطة التحكم والتشغيل</small></span><?php cc_status_badge('Phase 2', 'neutral'); ?></div>
            <div class="source-row"><span class="source-row__icon"><?= cc_icon('briefcase') ?></span><span><strong>Reseller</strong><small>سلطة الموزعين والوصول</small></span><?php cc_status_badge('Phase 2', 'neutral'); ?></div>
