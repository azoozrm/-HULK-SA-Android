...
<section class="module-stack">
    ...
    <section class="panel">
        ...
        <div class="table-shell"><div class="table-scroll" tabindex="0"><table class="management-table"><thead><tr><th>الموزع</th><th>الحالة</th><th><?= $moduleKey === 'access-codes' ? 'كود الدخول' : ($moduleKey === 'hosts' ? 'الهوست' : 'آخر تحديث') ?></th><th>الإدارة</th></tr></thead><tbody>
        <?php foreach ($rows as $row): $id = (int) $row['reseller_id']; ?>
            <tr>
