...
<?php if ($moduleKey === 'releases'): ?>
    ...
    <section class="panel">
        ...
        <div class="table-shell"><div class="table-scroll" tabindex="0"><table><thead><tr><th>الإصدار</th><th>السياسة</th><th>الحالة</th><th>الإجراءات</th></tr></thead><tbody>
